-- Fix: validar_resultado_seguro INSERT into torneo_partidos_historial was missing
-- jugador1_id and jugador2_id (both NOT NULL, no default), causing every
-- confirmation to throw a constraint violation.
