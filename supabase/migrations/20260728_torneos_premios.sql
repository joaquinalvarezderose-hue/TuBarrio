...
-- torneos.premios
--
-- Antes hardcodeado "Del 1° al 4°" en TournamentDetails.tsx. Ahora es
-- una fila mas de torneos, editable por admin/organizador desde
-- OrganizadorTorneoForm.tsx via crear_torneo / actualizar_configuracion_torneo.
-- ============================================================

ALTER TABLE public.torneos
  ADD COLUMN IF NOT EXISTS premios text NOT NULL DEFAULT 'Del 1° al 4°';
...
BEGIN
  ...
  INSERT INTO public.torneos (
    ...
    precio_expensas, precio_transferencia, premios
  )
  VALUES (
    v_titulo,
