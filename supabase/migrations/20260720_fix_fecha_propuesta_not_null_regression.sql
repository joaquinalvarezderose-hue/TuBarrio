-- Fix regression introduced by 20260720_allow_out_of_order_jornada_results.sql:
-- fecha_propuesta and propuesta_por (both NOT NULL) were dropped from the
-- INSERT column list again while removing the jornada-ordering checks,
-- causing "null value in column fecha_propuesta violates not-null constraint".
