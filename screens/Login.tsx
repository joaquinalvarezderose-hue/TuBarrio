    ...
    <div className="bg-background text-on-background min-h-screen flex flex-col items-center justify-center p-6 selection:bg-primary selection:text-on-primary">
      ...
      <main className="w-full max-w-[400px]">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-4 px-4 bg-surface border border-outline-variant text-on-surface font-headline font-semibold rounded-xl hover:bg-surface-variant transition-colors mb-4"
        >
        ...
        <div className="relative flex items-center gap-4 mb-4">
          ...
          <span className="text-xs text-on-surface-variant font-medium">o ingresá con email</span>
          <div className="flex-1 h-px bg-outline-variant"></div>
        </div>

        <div className="bg-surface rounded-xl shadow-sm border border-outline-variant p-8 mb-6">
